...
function prepare_rates(r, grid::GridTrait)
    r[grid.raterange], r[grid.noiserange], r[grid.gridrange]
end
...
function prepare_rates(r, hierarchical::HierarchicalTrait)
    ...
    rindividual = reshape(r[hierarchical.ratestart:end], hierarchical.nrates, hierarchical.nindividuals)
    rshared = reshape(r[1:hierarchical.ratestart-1], hierarchical.nrates, hierarchical.nhypersets)
    pindividual = reshape(param[hierarchical.paramstart:end], hierarchical.nparams, hierarchical.nindividuals)
