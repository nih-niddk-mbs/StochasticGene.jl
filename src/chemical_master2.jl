...
"""
function offonPDF(T,TA,TI,t::Vector,r::Vector,n::Int,nr::Int,method)
...
function offonPDF_offeject(T,TA,TI,t::Vector,r::Vector,n::Int,nr::Int,method)
...
"""
function ontimeCDF(tin::Vector,n::Int,nr::Int,TA::SparseMatrixCSC,pss::Vector,method)
...
function offtimeCDF(tin::Vector,r::Vector,n::Int,nr::Int,TI::SparseMatrixCSC,pss::Vector,method)
...
for single allele
"""
function steady_state(nhist::Int,P::AbstractMatrix,T::AbstractMatrix,B::AbstractMatrix,tol = 1e-8,stepmax=10000)
    total = size(P,2)
    steps = 0
    err = 1.
    A = T - B
...
"""
function time_evolve(t,M::SparseMatrixCSC,S0::Vector,method)
    if method == 1
...
function time_evolve(t,M::SparseMatrixCSC,Sinit::Vector)
...
"""
function time_evolve_diff(t,M::SparseMatrixCSC,P0)
