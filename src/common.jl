...
# struct AbstractGRSMmodel{RateType,PriorType,ProposalType,ParamType,MethodType,ComponentType,ReporterType} <: AbstractGRSMmodel{RateType,ReporterType}
#     rates::RateType
#     Gtransitions::Tuple
#     G::Int
#     R::Int
