...
struct GRSMtraitmodel{TraitType,RateType,nratesType,GType,PriorType,ProposalType,ParamType,MethodType,ComponentType,ReporterType} <: AbstractGRSMtraitmodel{TraitType}
    trait::TraitType
    rates::RateType
    nrates::nratesType
    Gtransitions::Tuple
