...
"""
    write_track_files(df::DataFrame, col_pattern::String, base_name::String, output_dir::String=".")
...
filenames = write_track_files(df, "data", "track", "output")
```
"""
function write_track_files(df::DataFrame, col_pattern::String, base_name::String, output_dir::String=".")
    ...
    for (i, col) in enumerate(data_cols)
        ...
        # Write data to file using writedlm
