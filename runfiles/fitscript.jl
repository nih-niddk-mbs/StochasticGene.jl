...
@time fit_rna(parse(Int,ARGS[1]),ARGS[2],ARGS[3],parse(Int,ARGS[4]),parse(Float64,ARGS[5]),ARGS[6],ARGS[7],ARGS[8],ARGS[9],ARGS[10],parse(Int,ARGS[11]),parse(Bool,ARGS[12]),parse(Bool,ARGS[13]),parse(Bool,ARGS[14]))
